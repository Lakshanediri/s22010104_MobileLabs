...
public class SensorActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private final float TEMPERATURE_THRESHOLD = 40.0f;
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (sensorEvent.sensor.getType() == Sensor.TYPE_AMBIENT_TEMPERATURE) {
            ...
            if (currentTemperature > TEMPERATURE_THRESHOLD) {
                ...
                textViewStatus.setText("warning!");
                ...
                textViewStatus.setText("Normal Temp");

                statusIndicatorCard.setCardBackgroundColor(Color.parseColor("#6E7EE7"));
